...
public class MonthCalendarSelectorHelper {
    private Calendar selectedMonth;
    private TextView tvMonth;
    private View btnNextMonth;
    private CalendarView calendarView;

    public MonthCalendarSelectorHelper(TextView tvMonth, View btnNextMonth, CalendarView calendarView) {
    ...
    private void updateMonthText() {
        ...
        calendarView.post(() -> {
            YearMonth ym = YearMonth.of(selectedMonth.get(Calendar.YEAR), selectedMonth.get(Calendar.MONTH) + 1);
